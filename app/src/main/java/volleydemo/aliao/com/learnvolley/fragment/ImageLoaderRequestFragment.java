...
import volleydemo.aliao.com.learnvolley.adapter.ImageLoaderAdapter;
 ...
 */
public class ImageLoaderRequestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        gridView.setAdapter(new ImageLoaderAdapter(getActivity(), Constants.IMAGE_URLS));
        return view;
    }
